# Best Western Omada Design Parameters

## Hardware Models & PoE Loads

| Category | Item | Part Number | PoE Load | Notes |
| :--- | :--- | :--- | :--- | :--- |
| **Guest AP** | In-Room Guest Room AP | EAP775-Wall | 25W | Wi-Fi 7 |
| **Guest AP** | Shared Guest Room AP | EAP775-Wall | 25W | 1 per 2 rooms (Drywall) |
